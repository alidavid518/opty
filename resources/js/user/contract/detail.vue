          ...
          <v-col cols="12">
            <v-simple-table>
              ...
              <tr>
                ...
                <td>{{asp_name}}</td>
                <td>{{campaign_name}}</td>
                <td>{{$date(reward_pay_at).format('YYYY/MM/DD HH:mm')}}</td>
                <td>{{format(reward_estimate)}}円</td>
                <td>{{format(contract)}}</td>
                <td>{{format(accept)}}</td>
                <td>{{format(accept_amount)}}円</td>
              </tr>
              </tbody>
            </v-simple-table>
          </v-col>
        ...
        <v-simple-table>
          <template v-slot:default>
            ...
            <tr v-for="item in items" :key="item.id">
              ...
              <td>{{$date(item.reward.create_at).format('YYYY/MM/DD HH:mm')}}</td>
              <td>{{$date(item.reward.pay_at).format('YYYY/MM/DD HH:mm')}}</td>
              <td>{{format(item.reward.amount)}}円</td>
              <td>{{format(item.reward.count)}}</td>
              <td>{{item.reward.status === 1 ? '承認' : '未承認'}}</td>
              <td>
  ...
  export default {
    ...
    mounted() {
      ...
      this.all_items = [
        ...
        {id: 1, asp_name: 'asp1', campaign_name: 'campaign1', reward: {create_at:'2020-01-01 12:00',pay_at:'2020-01-05 12:00',amount:10000,count:1,status:1}},
        {id: 2, asp_name: 'asp1', campaign_name: 'campaign1', reward: {create_at:'2020-01-01 12:00',pay_at:'2020-01-05 12:00',amount:10000,count:1,status:0}},
        {id: 3, asp_name: 'asp1', campaign_name: 'campaign1', reward: {create_at:'2020-01-01 12:00',pay_at:'2020-01-05 12:00',amount:10000,count:1,status:1}},
        {id: 4, asp_name: 'asp1', campaign_name: 'campaign1', reward: {create_at:'2020-01-01 12:00',pay_at:'2020-01-05 12:00',amount:10000,count:1,status:0}},
        {id: 5, asp_name: 'asp1', campaign_name: 'campaign1', reward: {create_at:'2020-01-01 12:00',pay_at:'2020-01-05 12:00',amount:10000,count:1,status:0}},
      ]
      this.filter()
    },
    methods: {
