    ...
    >
      <v-card>
            ...
            <v-row>
              <v-col cols="6">
                <v-row>
                  ...
                  <v-col cols="12">
                    <v-text-field dense outlined hide-details v-model="item.member_id"/>
                  </v-col>
                </v-row>
              </v-col>
              <v-col cols="6">
                <v-row>
                  ...
                  <v-col cols="12">
                    <v-text-field dense outlined hide-details v-model="item.team_id"/>
                  </v-col>
                </v-row>
              </v-col>
              <v-col cols="12">
                <v-row>
                  ...
                  <v-col cols="12">
                    <v-text-field dense outlined hide-details v-model="item.keyword"/>
                  </v-col>
                </v-row>
              </v-col>
              <v-col cols="12">
        ...
        <v-card-actions class="_action justify-center">
          <v-btn @click="$emit('onEditExtendClose')">キャンセル</v-btn>
          <v-btn dark color="success" @click="$emit('onEditExtend', item)">保存</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
  </v-row>
  ...
  export default {
    props: {
      ...
      item: {
        ...
        search_type: {type: String, default: 'member'},
